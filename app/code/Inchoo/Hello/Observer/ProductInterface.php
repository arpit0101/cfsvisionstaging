 ...
 */
namespace Inchoo\Hello\Observer;
...
use Magento\Framework\Event\ObserverInterface;
	...
	use Webkul\Marketplace\Block\Sellerproducts;
    ...
    {   
         ...
         * @param Sellerproducts $sellerproducts
         */
    ...
    public function execute(\Magento\Framework\Event\Observer $observer, string $imageType = NULL)
        {
           ...
           /**
            ...
            foreach ($quote->getAllItems() as $quoteItem) {
                ...
                //$sellerName = $this->sellerproducts->create()->getSellerName($quoteItem->getProductId());
                ...
                $itemExtAttr->setImage($imageurl);
                $itemExtAttr->setVendor($product->getVendor());
