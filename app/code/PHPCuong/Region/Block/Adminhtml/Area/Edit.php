...
namespace PHPCuong\Region\Block\Adminhtml\Area;
...
class Edit extends Container
{
    ...
    {
        $this->_objectId = 'phpcuong_area_id';
        $this->_blockGroup = 'PHPCuong_Region';
        $this->_controller = 'adminhtml_area';
        parent::_construct();

        if ($this->_isAllowedAction('PHPCuong_Region::area_edit')) {
                ...
                if ($region->getAreaId()) {
                    $this->buttonList->add(
                        ...
                        [
                            'label'   => __('Delete'),
                            'class'   => 'delete',
                            'onclick' => 'deleteConfirm("Are you sure you want to delete this area?", "'.$this->getDeleteUrl().'")'
                        ],
                        -100
                    );
                }
