...
class AreaActions extends \Magento\Ui\Component\Listing\Columns\Column
{
     ...
     * @var string
     */
    const URL_PATH_EDIT = 'phpcuong/area/edit';
    /**
     * Url path  to delete
     *
     * @var string
     */
    const URL_PATH_DELETE = 'phpcuong/area/delete';
    /**
     * URL builder
     *
                    ...
                    $item[$this->getData('name')] = [
                        ...
                        'delete' => [
                            ...
                            'confirm' => [
                                ...
                                'message' => __('Are you sure you wan\'t to delete the Area "${ $.$data.default_name }" ?')
                            ]
                        ]
                    ];
                }
