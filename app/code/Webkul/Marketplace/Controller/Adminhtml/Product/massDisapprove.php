...
class massDisapprove extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        foreach ($collection as $item) {
            ...
            $item->save();
            $this->_objectManager->create('Magento\Catalog\Model\Product')->load($item->getMageproductId())->setStatus(2)->save();
            ...
            $this->_objectManager->create('Webkul\Marketplace\Helper\Email')->sendSellerDisapproveMail($emailTemplateVariables,$senderInfo,$receiverInfo);
        }
