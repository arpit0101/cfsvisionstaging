...
class Edit extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        $resultPage->addContent($resultPage->getLayout()->createBlock('Webkul\Marketplace\Block\Adminhtml\Seller\Edit'));
            $resultPage->addLeft($resultPage->getLayout()->createBlock('Webkul\Marketplace\Block\Adminhtml\Seller\Edit\Tabs'));
