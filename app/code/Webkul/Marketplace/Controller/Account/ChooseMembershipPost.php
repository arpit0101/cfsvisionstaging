...
class ChooseMembershipPost extends Action
{
    /**
    ...
    public function execute()
    {
        ...
        $session = $this->_objectManager->create('Magento\Customer\Model\Session');
            ...
            try{
              ...
              $this->messageManager->addSuccess(__("Your account created  succesfully."));
                //$customer = $this->_objectManager->create('Magento\Customer\Model\Customer')->load($current_customer_id);
