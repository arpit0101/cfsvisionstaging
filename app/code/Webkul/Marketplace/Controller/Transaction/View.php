...
class View extends Action
{
    ...
    public function execute()
    {
        ...
        $collection = $this->_objectManager->create('Webkul\Marketplace\Model\Sellertransaction')->getCollection()
        ->addFieldToFilter(
            'seller_id',
        ...
        if(count($collection)){
            ...
            $resultPage->getConfig()->getTitle()->set(__('Marketplace Seller Transactions'));
            return $resultPage;
        }else{
