...
class Collection extends SaleslistCollection implements SearchResultInterface
{
    ...
    protected function _renderFiltersBefore()
    {
        ...
        $this->getSelect()->join($sales_order.' as so','main_table.order_id = so.entity_id', array("status" => "status"));

        $this->getSelect()->join($sales_order_item.' as soi','main_table.order_item_id = soi.item_id AND main_table.order_id = soi.order_id',array("item_id" => "item_id","qty_canceled"=>"qty_canceled","qty_invoiced"=>"qty_invoiced","qty_ordered"=>"qty_ordered","qty_refunded"=>"qty_refunded","qty_shipped"=>"qty_shipped","product_options"=>"product_options","mage_parent_item_id"=>"parent_item_id"))->where("main_table.parent_item_id IS NULL AND main_table.order_id!=0");
