...
class Collection extends SellerCollection implements SearchResultInterface
{
    ...
    protected function _renderFiltersBefore()
    {
        ...
        $this->getSelect()->join($joinTable.' as cgf','main_table.seller_id = cgf.entity_id', array('name'=>'name','email'=>'email','billing_telephone'=>'billing_telephone','billing_postcode'=>'billing_postcode','billing_country_id'=>'billing_country_id','billing_region'=>'billing_region','website_id'=>'website_id','created_at'=>'created_at'));
