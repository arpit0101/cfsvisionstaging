...
class Report extends \Magento\Framework\Model\AbstractModel
{
     ...
     */
    const CACHE_TAG = 'marketplace_report';

    /**
     * @var string
     */
    protected $_cacheTag = 'marketplace_report';
     ...
     * @var string
     */
    protected $_eventPrefix = 'marketplace_report';
    ...
    {
        $this->_init('Webkul\Marketplace\Model\ResourceModel\Report');
    }
