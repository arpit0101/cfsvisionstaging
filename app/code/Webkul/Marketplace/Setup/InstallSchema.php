...
class InstallSchema implements InstallSchemaInterface
{
    ...
    public function install(SchemaSetupInterface $setup, ModuleContextInterface $context)
    {
        ...
        /**
         * Create table 'marketplace_chatroom'
         */
        $table = $installer->getConnection()
            ->newTable($installer->getTable('marketplace_chatroom'))
            ->addColumn(
                'entity_id',
                \Magento\Framework\DB\Ddl\Table::TYPE_INTEGER,
                null,
            ...
            ->setComment('Marketplace Chat Room Table');
        $installer->getConnection()->createTable($table);
         ...
         */
        $table = $installer->getConnection()
            ->newTable($installer->getTable('marketplace_message'))
            ->addColumn(
                'entity_id',
                \Magento\Framework\DB\Ddl\Table::TYPE_INTEGER,
                null,
            ...
            ->setComment('Marketplace Chat Message Table');
        $installer->getConnection()->createTable($table);
         ...
         */
        $table = $installer->getConnection()
            ->newTable($installer->getTable('marketplace_verifymobile'))
            ->addColumn(
                'entity_id',
                \Magento\Framework\DB\Ddl\Table::TYPE_INTEGER,
                null,
            ...
            ->setComment('Marketplace mobile otp verification Table');
        $installer->getConnection()->createTable($table);
