 ...
 */
class Homesaleitems extends AbstractProduct
{
    ...
    */
    ...
    public function _getProductCollection()
    {
        if (!$this->productlists) {
            ...
            $collection-> addAttributeToFilter('visibility', array('in' => array(4) ))->addFinalPrice()->getSelect()->order('RAND()')->where('price_index.final_price < price_index.price');
