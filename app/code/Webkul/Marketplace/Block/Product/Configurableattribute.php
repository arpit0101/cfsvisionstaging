...
class Configurableattribute extends \Magento\Framework\View\Element\Template
{
    ...
    */
    ...
    public function getConfAttrCollection($value='')
    {
        return $this->_objectManager->create('Magento\Eav\Model\Entity')->setType('catalog_product')->getTypeId();
    }

    public function getAttributeSetCollection()
    {
        $entityTypeId = $this->_objectManager->create('Magento\Eav\Model\Entity')->setType('catalog_product')->getTypeId();
        $allowed=explode(',',$this->_objectManager->create('Webkul\Marketplace\Helper\Data')->getAllowedAttributesetIds());
        $attributeSetCollection = $this->_objectManager->create('Magento\Eav\Model\Entity\Attribute\Set')
        ->getCollection()
    ...
    public function getAttributeSetGroupCollection()
    {
        $attributeSetCollection = $this->_objectManager->create('Magento\Eav\Model\Entity\Attribute\Group')
