 ...
 */
class Sellersaleitems extends AbstractProduct
{
    ...
    */
    ...
    public function _getProductCollection()
    {
        if (!$this->productlists) {
            ...
            $collection-> addAttributeToFilter('visibility', array('in' => array(4) ))->addFinalPrice()->getSelect()->where('price_index.final_price < price_index.price');
