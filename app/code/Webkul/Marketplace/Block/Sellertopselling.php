 ...
 */
class Sellertopselling extends AbstractProduct
{
    ...
    */
    ...
    public function _getProductCollection()
    {
        if (!$this->productlists) {
            ...
            $bestsellerProducts = $this->_objectManager->create('Webkul\Marketplace\Helper\Data')->getBestsellerProducts();
            $bestsellerProductsIds = array();
            //echo $bestsellerProducts->count();
            if ($bestsellerProducts->count()){
                foreach ($bestsellerProducts as $key => $value) {
                    
                    $bestsellerProductsIds[]   =   $value->getData()['product_id'];
                }
            }
            $partner    = $this->getProfileDetail();
            //var_dump($bestsellerProductsIds);
