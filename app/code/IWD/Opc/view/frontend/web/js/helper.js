define(['iwdOpcSelectize', 'jquery', 'underscore', 'uiRegistry'], function (selectize, $, _, registry) {
    (function ($, window, document) {
		...
		$(document).on('click', '.method-data', function(){
			console.log("gbhgbhbhbh");
			$(document).find('.method-data').removeClass('active');
			$(this).addClass('active test');	
			var ptype = jQuery(this).attr('rel');
			console.log(ptype);
			$(document).find("#iwd_opc_payment_method_select option:selected").removeAttr('selected');;
			$(document).find("#iwd_opc_payment_method_select").val(ptype).trigger('change');
			$(document).find('#iwd_opc_payment_method_select option[value='+ptype+']').attr('selected','selected');
			$(document).find("#iwd_opc_payment_method_select").val(ptype);
			//$(document).find("#iwd_opc_payment_method_select").val(ptype).trigger('change');
			$(document).find("#iwd_opc_payment_method_select").addClass('bbgbgbgbg');
		});
