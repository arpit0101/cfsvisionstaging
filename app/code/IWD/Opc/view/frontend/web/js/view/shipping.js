define(
    ...
    function ($,
        ...
        var newAddressOption = {
			...
			// console.log(jQuery("#area_name").val());
			if(address.getType() === 'customer-address' && jQuery("#city_name").length>0 && jQuery("#area_name").length>0){
				// console.log('true');
				// console.log(address.city);
				// console.log(address.region);
				if(address.region==jQuery("#city_name").val() && address.city==jQuery("#area_name").val()){
					// console.log('yes show address');
					return true;
				}
			}
            return false;
