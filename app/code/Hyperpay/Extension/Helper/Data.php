...
class Data extends \Magento\Framework\App\Helper\AbstractHelper
{
    ...
    */
    ...
    public function getPaymentMarkImageUrl($code)
    {
        ...
        switch ($code) {
            case 'HyperPay_Visa':
                $paymentImage =$this->_assetRepo->getUrl("Hyperpay_Extension::images/visa.png");
                break;
            case 'HyperPay_Mada':
                $paymentImage =$this->_assetRepo->getUrl("Hyperpay_Extension::images/mada.png");;
                break;
            case 'HyperPay_SadadNcb':
                $paymentImage= $this->_assetRepo->getUrl("Hyperpay_Extension::images/sadad.png");;
                break;
            case 'HyperPay_PayPal':
                $paymentImage= $this->_assetRepo->getUrl("Hyperpay_Extension::images/paypal.png");;
                break;
            case 'HyperPay_Master':
                $paymentImage= $this->_assetRepo->getUrl("Hyperpay_Extension::images/master.png");;
                break;
            case 'HyperPay_Amex':
                $paymentImage= $this->_assetRepo->getUrl("Hyperpay_Extension::images/amex.png");;
                break;
