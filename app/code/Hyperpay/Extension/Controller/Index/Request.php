...
class Request extends \Magento\Framework\App\Action\Action
{
    ...
    public function prepareTheCheckout($order)
    {
        ...
        $data = "authentication.userId=".$this->_adapter->getUserId().
        "&authentication.password=".$this->_adapter->getPassword().
        "&authentication.entityId=".$this->_adapter->getEntity($payment).
        "&amount=".$grandTotal.
        "&currency=".$currency.
